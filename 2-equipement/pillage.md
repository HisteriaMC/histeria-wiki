...
## Description
Le chercheur de coffre est utile pour trouver des bases à piller. Ce dernier donne le nombre de conteneur(s), comme les coffres, les tonneaux, les fours, etc... dans un carré de 7 chunks autour du joueur. Seul le [coffre en Nocturite](https://histeria.fr/wiki/2-equipement/base) n'est pas repéré par le chercheur de coffre.
